...
describe("Initial Tests", () => {
  ...
  it("should handle default read one after create operations", async () => {
    ...
    const create = await POST(server, '/api/Model', { firstName: "firstName", lastName: "lastName" });
  ...
  it("should handle default update operations", async () => {
    ...
    const update = await PUT(server, '/api/Model/' + create.json.id, { firstName: "newFirstName", lastName: "newLastName" });
  ...
  it("should handle custom user auth example", async () => {
    ...
    router.get("/alternative-model", async (ctx, next) => {
